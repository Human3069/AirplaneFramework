...
namespace SWS
{
    ...
    public class PathEditor : Editor
    {
        ...
        protected PathModifierOption editOption = PathModifierOption.SelectModifier;
        ...
        */
        ...
        protected void SetWaypoint(int index, Transform waypoint)
        {
        ...
        protected Transform GetWaypointAtIndex(int index)
        {
        ...
        void OnSceneGUI()
        {
            ...
            for (int i = 0; i < waypoints.Length; i++)
            {
                ...
                var fmh_300_47_638743945618055182 = Quaternion.identity; Handles.FreeMoveHandle(wpPos, size, Vector3.zero, (controlID, position, rotation, hSize, eventType) => 
                {
		...
		protected virtual void DrawPathOptions()
		{
		...
		protected void RenameWaypoints(Transform[] waypoints, bool skipCustom)
		{
    ...
    public enum PathModifierOption
    {
        SelectModifier,
        PlaceToGround,
        InvertDirection,
